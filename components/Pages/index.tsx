...
const Page: PageEl = (props, state:
  ...
  form:string,
  book:{
    title:string, auther:string, country:string,
  ...
  return (
    <div style={{ direction: "rtl", minHeight: "11vh"}}>
      ...
      {state.form == "bookspecs" ? <WindowFloat
        ...
        <g-b style={{backgroundColor: state.cart.includes(state.book.title)?"#BB1515" : "#15BB68"}} 
      ...
      <Window title="سبد خرید" style={{ margin: 10, width: "calc(100% - 20px)" }}>
        <f-cse style={{width:"100%", height: 60}}>
          ...
          <f-14>تعداد کتاب ها:{state.cart.length.toLocaleString("fa-IR")}</f-14>
        </f-cse>
        </Window>
